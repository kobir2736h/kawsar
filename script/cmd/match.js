...
module.exports.run = async function({ api, args, Users, event }) {
  ...
  let Avatar = (await axios.get(`https://graph.facebook.com/${mention}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`, { responseType: "arraybuffer" })).data;
  ...
  var msg = {
    body: `⚡️The love ratio between ${namee} and ${name} is ${tle}% 🥰`, 
    mentions: arraytag, 
    attachment: imglove
  }
