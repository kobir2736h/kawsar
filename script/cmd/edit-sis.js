...
module.exports.onLoad = async() => {
    ...
    const imgPath = path.join(dirMaterial, "sis.png");
    const url = "https://i.imgur.com/n2FGJFe.jpg";
...
async function makeImage({ one, two }) {
    ...
    let batgiam_img = await jimp.read(path.join(__root, "sis.png"));
